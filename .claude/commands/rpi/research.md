...
|-------|-------|------|----------|
| Phase 1 | requirement-parser | Custom | .claude/agents/rpi/requirement-parser.md |
| Phase 2 | product-manager | Custom | .claude/agents/rpi/product-manager.md |
| Phase 2.5 | Explore | Built-in | Task tool with subagent_type="Explore" |
| Phase 3 | senior-software-engineer | Custom | .claude/agents/rpi/senior-software-engineer.md |
| Phase 4 | technical-cto-advisor | Custom | .claude/agents/rpi/technical-cto-advisor.md |
